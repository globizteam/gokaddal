 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWw34fsdfsdw345345vniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76854535345345023908987329309657453542496749683645');
...
define('HTTP_ROOT','http://'.$_SERVER['HTTP_HOST'].'/gokaddal/');