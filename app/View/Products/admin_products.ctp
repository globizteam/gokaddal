                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod"> Ads List</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="asset-inner">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo $this->Html->url([ 'controller' => 'Users', 'action' => 'addUser','admin'=> true,@$product['User']['id'] ]); ?>"> <?php echo @$product['User']['first_name'].' '.@$product['User']['last_name'];?> </a></td>
