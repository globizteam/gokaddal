                ...
                <div class="row">
                    <!-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Users</h5>
                                <h2><span class="counter"><?php echo $totalUsers; ?></span> <span class="tuition-fees">Total Users</span></h2>
                    ...
                    <!-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>Ads</h5>
                                <h2><span class="counter"><?php echo $totalProducts; ?></span> <span class="tuition-fees">Total Ads Posted</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>Total Reported Ads</h5>
                                <h2><span class="counter"><?php echo $totalReportedProducts; ?></span> <span class="tuition-fees">Total Reported Ads</span></h2>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-sales-chart">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Reports</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <ul class="list-inline cus-product-sl-rp">
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #006DF0;"></i>Daily Report</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #933EC5;"></i>Monthly Report</h5>
                                </li>
                                <li>
                                    <h5><i class="fa fa-circle" style="color: #65b12d;"></i>Yearly Report</h5>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="<?php echo $this->webroot; ?>/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="<?php echo $this->webroot; ?>/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="<?php echo $this->webroot; ?>/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="<?php echo $this->webroot; ?>/img/courses/1.jpg" alt="" /></a>
