                                        ...
                                        <div class="listing_item_sec">
                                            ...
                                            <?php 
                                                if ( !empty($requirement_list) ) 
                                                {
                                                    ...
                                                    {
                                            ?>
                                                    <a href="<?php echo $this->webroot.'home/my_solution_detail/'.$requirement['SeekerRequirement']['id']; ?>">
                                                        <div class="listing_item bg_white_item <?php if($requirement['SeekerRequirement']['read_status'] == 0 ) { echo 'notification_border_orange'; } ?> ">
                                                            <h5>
                                                                <a href="<?php echo $this->webroot.'home/my_requirement_detail/'.$requirement['SeekerRequirement']['id']; ?>" class="txt_black hover_txt_orange">
                                                            ...
                                                            <h5 class="txt_w_400 m_t_10 txt_12">
                                                                <a href="javascript:;" class="txt_grey">
                                                                    ...
                                                                    <?php
                                                                        $created_at = $requirement['SeekerRequirement']['created_at'];    
