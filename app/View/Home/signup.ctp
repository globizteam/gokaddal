    ...
    <script src="/gokaddal-staging/gokaddal/js/jquery.min.js"></script>
                       ...
                       <h4 class="text-center txt_grey txt_w_400">Lorem ipsum dolor sit amet, consectetur.</h4> -->
                        ...
                        <div class="form_with_grey_bg">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <input type="text" name="company_name" class="form-control input_field" placeholder="Enter name of your company">
                                </div>
                                <div class="form-group">
